...
class mySPDF:
   ...
   #     d = {'Error': ['Error writing to Sharepoint']}
   ...
   #     d = {'Success': ['File loaded to Sharepoint']}
    ...
    def getUser(self,recipientsFile,**kwargs):
        ...
        self.user="ISCBI001@bd.com"
        self.pwd="52SQ6I>*P+*63*Z"       
    ...
    def setCookies(self,SP,spSite,**kwargs):#spSite
        ...
        self.site= Site(spSite,version=Version.v2016, authcookie=self.authcookie,timeout=999999)
    ...
    def writeToSPFolder(self,SP,spSite,folder,file,localFolder,successFile,errorFile,**kwargs):#spSite,folder,file,localFolder
        ...
        print('Sharepoint Folder for write = ',self.spFolder)
    ...
    def getFolderFilesList(self, SP, spSite, spFolder, columns):
        ######################################################################################
        # Author: Josue Macias / Israel V.
        # Date: June 15 2022
        # This method returns a pandas dataframe with the "File Name" and "Last modification date" 
        # of the files inside a SharePoint library 
        ######################################################################################
    ...
    def readDataFromExcelInSharePoint(self, SP, spSite, spLibrary, file):
        ...
        # Author: Josue Macias / Israel V.
        # Date: June 15 2022
        # This method returns as binary type the content of a specific file 
        ######################################################################################
        self.setCookies(SP,spSite)        
    ...
    def readExcelFileFromFolder(self, SP, spSite, spLibrary, file, **kwargs):
        ...
        # Author: Josue Macias / Israel V.
        # Date: June 15 2022
        # This method returns a pandas data frame with the content of a specific file. This 
        # method may contains a sheet name or not as argument
        ######################################################################################
